...
public class CommandSwerveDrivetrain extends SwerveDrivetrain implements Subsystem {
    ...
    public void setOdometryVisionMeasurement(Pose2d estimatedCamPose, double camTimestampSecs) {
        // Was getting error that would stop the code and crash it. Adding a try and chat statement solved the problem
        try {
            SmartDashboard.putString("Vision Status", "Working as intended");
            m_odometry.addVisionMeasurement(estimatedCamPose, camTimestampSecs);
        } catch (Exception ex) {
            SmartDashboard.putString("Vision Status", "Vision is struggling plz help");
        }
    }
